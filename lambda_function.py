...
def deploy(event):
    ...
    modrepourl        = body['modrepourl']
    modreponame       = body['modreponame']
    implrepourl       = body['implrepourl']
    implreponame      = body['implreponame']
    iamrepourl        = body['iamrepourl']
    iamreponame       = body['iamreponame']
    destreponame      = body['destreponame']
    githubuser        = body['githubuser']
    repopat           = body['repopat']
    ...
    architecture['modrepourl']   = modrepourl
    architecture['modreponame']  = modreponame
    architecture['implrepourl']  = implrepourl
    architecture['implreponame'] = implreponame
    architecture['iamrepourl']   = iamrepourl
    architecture['iamreponame']  = iamreponame
    architecture['destreponame'] = destreponame
    architecture['githubuser']   = githubuser
    architecture['repopat']      = repopat
    architecture['githubemail']  = githubemail
